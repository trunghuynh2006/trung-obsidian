...
Pages created: wiki/sources/design-patterns-reimagined, wiki/concepts/singleton-pattern, wiki/concepts/abstract-factory-pattern, wiki/concepts/flyweight-pattern, wiki/concepts/interpreter-pattern, wiki/concepts/observer-pattern, wiki/concepts/strategy-pattern, wiki/concepts/proxy-pattern, wiki/concepts/cqrs, wiki/concepts/circuit-breaker, wiki/concepts/saga-pattern, wiki/concepts/event-sourcing, wiki/concepts/async-await, wiki/concepts/backpressure, wiki/concepts/actor-model, wiki/concepts/repository-pattern, wiki/concepts/cqrs-event-sourcing.
Pages updated: wiki/index (+source, +16 concepts under new GoF/Modern Patterns section), wiki/overview (+GoF domain section, 9 domains total, 3 new open questions).
